'''
Description: from nerfstudio
Author: 
Date: 2023-02-27 09:58:55
LastEditTime: 2023-03-13 18:36:07
...
class MLP(nn.Module):
    ...
    def __init__(
        ...
        activation: Optional[nn.Module] = nn.Softplus(beta=100),
        ...
        self.net = None
        self._build_nn_modules()
        

    def _build_nn_modules(self) -> None:
