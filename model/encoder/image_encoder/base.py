...
LastEditTime: 2022-11-22 13:28:03
...
from model.layer.norm_layer import get_norm_layer
...
class SpatialEncoding(nn.Module):
    ...
    def __init__(
        ...
        """
        :param backbone Backbone network. Either custom, or model from torchvision is used
        ...
        if self.use_custom_resnet:
            ...
            self.model = getattr(torchvision.models, backbone)(pretrained=pretrained, norm_layer=get_norm_layer(norm_type))
